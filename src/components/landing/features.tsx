...
export function Features() {
  return (
    <section
      id='features'
      className='scroll-mt-4 bg-white pt-8 pb-16 md:pt-12 md:pb-32'
    >
      <div className='mx-auto max-w-3xl px-6 lg:max-w-5xl'>
        <div className='relative'>
          <div className='relative z-10 grid grid-cols-6 gap-3'>
            <Card className='relative col-span-full flex overflow-hidden border-zinc-200 bg-white lg:col-span-2'>
              <CardContent className='relative m-auto size-fit pt-6'>
                <div className='relative flex h-24 w-56 items-center'>
                  ...
                  <span className='mx-auto block w-fit text-5xl font-semibold text-zinc-900'>
                    100%
                  </span>
                </div>
                <h2 className='mt-6 text-center text-3xl font-semibold text-zinc-900'>
                  Flexible
                </h2>
              </CardContent>
            </Card>
            <Card className='relative col-span-full overflow-hidden border-zinc-200 bg-white sm:col-span-3 lg:col-span-2'>
              <CardContent className='pt-6'>
                <div className='relative mx-auto flex aspect-square size-32 rounded-full border-2 border-zinc-800 before:absolute before:-inset-2 before:rounded-full before:border-2 before:border-zinc-700'>
                  <svg
                  ...
                  >
                    ...
                    <defs>
                      ...
                      >
                        ...
                        <stop offset='1' stopColor='#1F7D67' />
                      </linearGradient>
                ...
                <div className='relative z-10 mt-6 space-y-2 text-center'>
                  <h2 className='group-hover:text-secondary-950 text-lg font-medium text-zinc-800 transition'>
                    Datos Seguros
                  </h2>
                  <p className='text-zinc-600'>
                    Tus datos financieros están protegidos con encriptación de
                    nivel bancario y respaldos automáticos.
                  </p>
                </div>
              </CardContent>
            </Card>
            <Card className='relative col-span-full overflow-hidden border-zinc-200 bg-white sm:col-span-3 lg:col-span-2'>
              <CardContent className='pt-6'>
                <div className='pt-6 lg:px-6'>
                  ...
                  >
                    ...
                    <g>
                      ...
                      />
                      <path
                        d='M35 40 L35 48 M31 44 L35 48 L39 44'
                      ...
                      {/* Flecha 1 */}
                      <path
                        d='M55 50 L75 50 M70 45 L75 50 L70 55'
                      ...
                      {/* Flecha 2 */}
                      <path
                        d='M120 50 L140 50 M135 45 L140 50 L135 55'
                        className='stroke-zinc-700'
                        strokeWidth='2'
                        strokeLinecap='round'
                        strokeLinejoin='round'
                    ...
                    <text
                      ...
                      y='80'
                      textAnchor='middle'
                      className='fill-zinc-600 text-xs font-medium'
                    >
                      Abre
                    </text>
                    <text
                ...
                <div className='relative z-10 mt-14 space-y-2 text-center'>
                  ...
                  <p className='text-zinc-600'>
                    No hace falta abrir la app. Registra tus gastos directamente
                    desde WhatsApp en segundos.
                  </p>
                </div>
              </CardContent>
            </Card>
            <Card className='relative col-span-full overflow-hidden border-zinc-200 bg-white lg:col-span-3'>
              <CardContent className='grid pt-6 sm:grid-cols-2'>
                <div className='relative z-10 flex flex-col justify-between space-y-12 lg:space-y-6'>
                  <div className='relative flex aspect-square size-12 rounded-full border-2 border-zinc-800 before:absolute before:-inset-2 before:rounded-full before:border-2 before:border-zinc-700'>
                    <PieChart
                      className='m-auto size-5 text-zinc-800'
                      strokeWidth={2}
                    />
                  </div>
                  <div className='space-y-2'>
                    ...
                    <p className='text-zinc-600'>
                      Gráficos y estadísticas claras para entender tus patrones
                      de gasto al instante.
                    </p>
                  </div>
                </div>
                <div className='relative mt-6 -mr-6 -mb-6 h-fit rounded-tl-(--radius) border-t border-l border-zinc-400 p-6 py-6 sm:ml-6'>
                  <div className='absolute top-2 left-3 flex gap-1'>
                    <span className='block size-2 rounded-full border-2 border-zinc-800 bg-zinc-800'></span>
                    <span className='block size-2 rounded-full border-2 border-zinc-800 bg-zinc-800'></span>
                    <span className='block size-2 rounded-full border-2 border-zinc-800 bg-zinc-800'></span>
                  </div>
                  <svg
                  ...
                  >
                    ...
                    <defs>
                      <linearGradient
                        ...
                        gradientUnits='userSpaceOnUse'
                      >
                        <stop stopColor='#1F7D67' stopOpacity='0.15' />
                        <stop
                          offset='1'
                          stopColor='#1F7D67'
                          stopOpacity='0.01'
            ...
            <Card className='relative col-span-full overflow-hidden border-zinc-200 bg-white lg:col-span-3'>
              <CardContent className='grid h-full pt-6 sm:grid-cols-2'>
                <div className='relative z-10 flex flex-col justify-between space-y-12 lg:space-y-6'>
                  <div className='relative flex aspect-square size-12 rounded-full border-2 border-zinc-800 before:absolute before:-inset-2 before:rounded-full before:border-2 before:border-zinc-700'>
                    <Users
                      className='m-auto size-6 text-zinc-800'
                      strokeWidth={2}
                    />
                  </div>
                  <div className='space-y-2'>
                    ...
                    <p className='text-zinc-600'>
                      Crea grupos, invita amigos y divide gastos de forma justa
                      y transparente con MoniTags.
                    </p>
                  </div>
                </div>
                <div className='relative mt-6 before:absolute before:inset-0 before:mx-auto before:w-px before:bg-zinc-400 sm:-my-6 sm:-mr-6'>
                  <div className='relative flex h-full flex-col justify-center space-y-6 py-6'>
                    <div className='relative flex w-[calc(50%+0.875rem)] items-center justify-end gap-2'>
                      <span className='block h-fit rounded border-2 border-zinc-500 px-2 py-1 text-xs text-zinc-700 shadow-sm'>
                        María
                      </span>
                    ...
                    <div className='relative ml-[calc(50%-1rem)] flex items-center gap-2'>
                      <div className='size-8 ring-4 ring-white'>
                        <div className='size-full rounded-full bg-gradient-to-br from-green-400 to-green-600' />
                      </div>
                      <span className='block h-fit rounded border-2 border-zinc-500 px-2 py-1 text-xs text-zinc-700 shadow-sm'>
                        Carlos
                      </span>
                    ...
                    <div className='relative flex w-[calc(50%+0.875rem)] items-center justify-end gap-2'>
                      ...
                      <div className='size-7 ring-4 ring-white'>
                        <div className='size-full rounded-full bg-gradient-to-br from-purple-400 to-purple-600' />
                      </div>
                    </div>
                  </div>
                </div>
