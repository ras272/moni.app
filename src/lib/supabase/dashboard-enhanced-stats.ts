 ...
 */
export async function getExpenseOverviewData(): Promise<ExpenseOverviewData> {
 ...
 */
export async function getWalletAccountsData(): Promise<WalletAccountData[]> {
 ...
 */
export async function getRevenueOverviewData(): Promise<RevenueItem[]> {
  const supabase = await createClient();
 ...
 */
export async function getRecentTransactionsEnhanced(
  days: number = 7,
  limit: number = 10
